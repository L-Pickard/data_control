SELECT N'Example LLC' AS [entity]
	...
	,COALESCE(NULLIF(h.[Currency Code], N''), N'USD') AS [currency_code]
	...
	,NULLIF(h.[$systemModifiedAt], '17530101') AS [last_modified]
	,CAST(0 AS BIT) AS [preorder]
	...
	,l.[VAT _] AS [vat_percentage]
	,l.[Line Discount _] AS [line_discount_percentage]
	,l.[Amount] AS [amount]
...
FROM [Example USA Master Setup$Sales Line$437dbf0e-84ff-417a-965d-ed2bb9650972] AS l
INNER JOIN [Example USA Master Setup$Sales Header$437dbf0e-84ff-417a-965d-ed2bb9650972] AS h
