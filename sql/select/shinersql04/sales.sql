...
FROM [Shiner USA Master Setup$Value Entry$437dbf0e-84ff-417a-965d-ed2bb9650972] AS ve

LEFT JOIN [Shiner USA Master Setup$Customer$437dbf0e-84ff-417a-965d-ed2bb9650972] AS cus
	ON ve.[Source No_] = cus.[No_]

LEFT JOIN [Shiner USA Master Setup$Sales Invoice Header$437dbf0e-84ff-417a-965d-ed2bb9650972] AS sih
	ON ve.[Document No_] = sih.[No_]

LEFT JOIN [Shiner USA Master Setup$Sales Cr_Memo Header$437dbf0e-84ff-417a-965d-ed2bb9650972] AS cmh
