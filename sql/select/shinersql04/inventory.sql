WITH physical_inventory AS (
	...
	FROM [Shiner USA Master Setup$Item Ledger Entry$437dbf0e-84ff-417a-965d-ed2bb9650972] AS ile
	...
	FROM [Shiner USA Master Setup$Reservation Entry$437dbf0e-84ff-417a-965d-ed2bb9650972] AS re
...
SELECT N'Shiner LLC' AS [entity], p.[item_id]
