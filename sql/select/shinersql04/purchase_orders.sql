SELECT 'Shiner LLC' AS [entity]
	...
	,CAST(NULL AS NVARCHAR(80)) AS [shiner_reference]
...
FROM [Shiner USA Master Setup$Purchase Line$437dbf0e-84ff-417a-965d-ed2bb9650972] AS pl

INNER JOIN [Shiner USA Master Setup$Purchase Header$437dbf0e-84ff-417a-965d-ed2bb9650972] AS ph
