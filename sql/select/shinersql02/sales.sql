...
FROM [Shiner$Value Entry] AS ve

LEFT JOIN [Shiner$Sales Cr_Memo Header] AS cmh
	ON ve.[Document No_] = cmh.[No_]

LEFT JOIN [Shiner$Sales Invoice Header] AS sih
	ON ve.[Document No_] = sih.[No_]

LEFT JOIN [Shiner$Customer] AS cus
...
FROM [Shiner BV$Value Entry] AS ve

LEFT JOIN [Shiner BV$Sales Cr_Memo Header] AS cmh
	ON ve.[Document No_] = cmh.[No_]

LEFT JOIN [Shiner BV$Sales Invoice Header] AS sih
	ON ve.[Document No_] = sih.[No_]

LEFT JOIN [Shiner BV$Customer] AS cus
	ON ve.[Source No_] = cus.[No_]

LEFT JOIN [Shiner BV$Item] AS it
