...
REFRESH_DIRECTORY = Path(
    r"\\SHINERSQL18\Users\leo.pickard\Desktop\Automated Projects\Refresh Files"
)
DOWNLOAD_DIRECTORY = Path(r"\\shinersql18\data_control\owtanet")
...
def run_polling() -> int:
    ...
    engine = get_sqlalchemy_engine("shinersql18", "data_control")
