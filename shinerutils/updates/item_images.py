...
from shinerutils.filesystem import (
    ...
    def from_environment(cls) -> ImageSourceSettings:
        ...
        return cls(
            ...
            sharepoint_hostname=environment_value(
                "IMAGE_SHAREPOINT_HOSTNAME", default="shinerltd.sharepoint.com"
            )
            or "shinerltd.sharepoint.com",
            sharepoint_site_path=environment_value(
                "IMAGE_SHAREPOINT_SITE_PATH", default="/sites/ShinerUKLtd"
            )
            or "/sites/ShinerUKLtd",
            ...
            item_docs_path=Path(
                environment_value(
                    "IMAGE_NAS_ITEM_DOCS_PATH", default=r"\\shinersql02\item_docs"
                )
                or r"\\shinersql02\item_docs"
            ),
            thumbnail_path=Path(
                environment_value(
                    "IMAGE_NAS_THUMBNAIL_PATH",
                    default=r"\\Shinernas01\ShinerData\MARKETING\001 Master Thumbnail Images",
                )
                or r"\\Shinernas01\ShinerData\MARKETING\001 Master Thumbnail Images"
            ),
