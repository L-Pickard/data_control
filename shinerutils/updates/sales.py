...
from shinerutils.utils import concurrent_df_load_params
...
def update_sales_table(
    ...
    try:
        ...
        start_date_ltd = get_sales_increment(engine_sql18, "Shiner Ltd")

        start_date_bv = get_sales_increment(engine_sql18, "Shiner B.V")

        start_date_llc = get_sales_increment(engine_sql18, "Shiner LLC")
